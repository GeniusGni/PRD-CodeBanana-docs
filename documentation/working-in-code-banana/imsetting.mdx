---
title: "Channel"
description: "Connect CodeBanana project agents to external messaging channels through IM Settings, create and bind bots, and integrate Feishu, Lark, Telegram, Slack, Discord, DingTalk, WeCom, QQ, and Mattermost for agent conversations outside CodeBanana."
---
...
<Frame>
  ![0723 Channel](/images/0723-channel.png "0723 Channel")
</Frame>
...
<Steps>
  <Step title="Open IM Setting">
    <Frame>
      ![Channelexam](/images/0723-IMfirststep.png)
    </Frame>
  </Step>
  <Step title="Add a New Bot">
    <Frame>
      ![Bindabot](/images/0723-IMFeishu.png)
    </Frame>
  </Step>
  <Step title="Created successfully">
    <Frame>
      ![0723 Feishudis](/images/0723-feishudis.png "0723 Feishudis")
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="Open channel config">
    <Frame>
      ![Bindbot](/images/0723-bindIMfirst.png)
    </Frame>
  </Step>
  <Step title="Binding a bot">
    <Frame>
      ![0723 Imbindingsecon](/images/0723-Imbindingsecon.png "0723 Imbindingsecon")
    </Frame>
  </Step>
</Steps>
...
<AccordionGroup>
  ...
  <Accordion title="WeCom (Enterprise WeChat)">
    ...
    - Log in to [https://work.weixin.qq.com/wework\_admin/frame#/manageTools](https://work.weixin.qq.com/wework_admin/frame#/manageTools)
    - Go to Security and Management → Management Tool
    ...
    - Configure name, logo, and visibility （All）→ **Save**

    #### **Messaging Configuration**

    - Edit the robot → Click **create by API mode**<br />
      <Frame>
        ![Image](/images/image-3.png)
      </Frame>
    - Choose keep-alive mode, and get **Bot ID** and **Secret**<br />
      <Frame>
        ![Image](/images/image-4.png)
      </Frame>
    - Go back to CodeBanana,
      - Go to IM Setting
      - Add a new bot
    - Configure as follow & **Save**<br />
      <Frame>
        ![Image](/images/image-5.png)
      </Frame>
    - **\[Important\]** Link a CodeBanana project to use the IM channel<br />
      <Frame>

---
description: "Set up CodeBanana Bot, the local desktop version of CodeBanana for macOS and Windows, and understand account sync, cloud and local projects, local files, terminal commands, app control, browser automation, screen understanding, and bot-only skills."
title: "Introduction"
---

...
<AccordionGroup>
  ...
  <Accordion title="Mattermost">
    ...
    - Log in to Mattermost Admin Console
      - https://\<your-domain\>/admin\_console
    ...
    - Role:
      - Recommended: System Admin
      - Or minimal: post:all, slash\_command:all
    - Save and copy the **Bot Token** (mmb-...)
    ...
    - Add your OpenClaw gateway address:
      - openclaw-server-ip
      - or [gateway.example.com](http://gateway.example.com)
    - Save changes

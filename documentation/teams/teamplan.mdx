...
Team Plan provides usage alerts across both member-level and team-level quotas.

- A warning is shown when remaining usage falls below **20%**
- When usage is fully consumed, a **Notification** is sent to inform the relevant user or team

Usage alerts apply to:

- Included requests
- Member token usage limits
- Shared token pool balance

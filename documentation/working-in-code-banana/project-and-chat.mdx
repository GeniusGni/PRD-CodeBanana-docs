...
![Projectlist](/images/0714-projectsort.png)

![Projectlist 1](/images/0714-projectfilter.png)

**Project notifications Settings**

Each project in the project list supports message-related management actions, allowing users to control visibility and notification behavior.<br />

<Frame>
  ![0714 Projectmessage](/images/0714-projectmessage.png)
</Frame>

**Available actions**

Users can access project actions from the **“…” menu**:

- **Pin / Unpin from top**
  - Pin important projects to keep them at the top of the project list
  - Unpin restores the default sorting behavior
- **Mark as unread**
  - Marks the project as unread
  - A red notification badge appears again on the project
  - The unread count is included in the total notification count shown in the left navigation bar
- **Mute notifications**
  - Mutes notifications from the selected project
  - The red notification badge changes to a gray indicator
  - Muted projects will no longer contribute unread counts to the left navigation bar

<Note>
  **Notification count**

  - New messages generate unread indicators on the corresponding project or chat
  - Unread counts are accumulated at multiple levels:
    - Individual project/chat level
    - Group by Project or Chat level which on left navigation bar
  - Muted projects are excluded from notification count calculations
</Note>
...
- Deletion is allowed **only if the owner has more than one project**
  <Frame>
    ![Operateproject](/images/0714-projectfilemanage.png)
  </Frame>
...
<Frame>
  ![Studio Page](/images/0714-projectcreate.png)
</Frame>
...
<Frame>
  ![Projectuserguide](/images/0714-projectuserguide.png)
</Frame>
...
<Frame>
  ![Inviteorgnew](/images/0714-invitememberproject.png)
</Frame>
...
<Frame>
  ![Inviteexternalnew](/images/0714-inviteexternalproject.png)
</Frame>
...
<Frame>
  ![Groupmanagement](/images/0714-membermanageproject.png)
</Frame>
...
<Frame>
  ![Messageaction](/images/0714-projectmessagetool.png)
</Frame>
...
<Frame>
  ![Newmessage](/images/0714-newmessage.png)
</Frame>
...
<Frame>
  ![Notification](/images/0714-notifica.png)
</Frame>

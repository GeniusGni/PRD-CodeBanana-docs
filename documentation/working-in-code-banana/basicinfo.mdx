---
title: "Basic info"
description: "Configure the agent's Basic Info, including Agent, Soul, Identity, User, and Memory fields, to shape task behavior, communication style, safety rules, personality, user preferences, and project-specific context."
---
...
<Frame>
  ![Basicinfo](/images/0723-basicinfo.png)
</Frame>
...
Defines the team members, roles, and collaboration context that the agent should understand.

Teams helps the agent know:
...
This information allows the agent to better coordinate teamwork and provide more relevant assistance in collaborative scenarios.
...
Defines local environment information, tool configurations, and project-specific instructions that help the agent use available tools correctly.

Tools provides additional context about:
...
This information is included in the agent’s system context and helps prevent incorrect tool usage.
...
<Frame>
  ![Setbasicinfo 1](/images/0723-infodetail.png)
</Frame>

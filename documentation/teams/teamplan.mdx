...
<Steps>
  ...
  <Step title="Select VM specifications and billing settings">
...
<AccordionGroup>
  <Accordion title="Why can’t I find a member in the “Add Members” list?">
  ...
  <Accordion title="What happens when a member exceeds the usage limit?">
  ...
  <Accordion title="Is the 30-day billing cycle fixed or rolling?">
  ...
  <Accordion title="Where can I view billing records?">
  ...
  <Accordion title="Can admins restrict which AI models team members can use?">
    Yes. In **Usage → Members & Quotas**, admins can configure model access for each member through the **Models** column. Members can be allowed to use all models or only a selected set. These limits also apply to projects owned by the restricted member.
  </Accordion>
</AccordionGroup>
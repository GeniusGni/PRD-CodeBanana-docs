---
title: "Agent modes"
description: "Understand CodeBanana chat modes and agent modes, including Team Agent, Private Ask, Discussion, Ask-only mode, Coding mode, CB Optimized Model, Claude Code, agent access control, project admins, and shared team collaboration."
---

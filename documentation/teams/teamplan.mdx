...
- The reminder asks the user to contact the organization owner or admin before usage is interrupted
  **_Reminder text_**
...
- This reminder is intended for the organization owner or admin so the pool can be topped up in time
  **_Reminder text_**

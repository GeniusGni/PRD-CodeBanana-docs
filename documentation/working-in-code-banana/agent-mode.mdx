---
title: "Agent modes"
description: "Understand CodeBanana chat modes and agent modes, including Team Agent, Private Ask, Discussion, Discussion Coordinator (DC), Coding mode, read-only agent behavior, shared and individual queue behavior, stopping controls, agent access control, project admins, and team collaboration."
---
...
<Frame>
  ![Chatmodes](/images/0714-agentmodes.png)
</Frame>
...
<Frame>
  ![Teamagentrequest](/images/0714-permission.png)
</Frame>
...
<Frame>
  ![Agentmode](/images/0714-agentconfigmodes.png)
</Frame>
...
<Frame>
  ![Myagent](/images/0714-privateask.png)
</Frame>
...
<Frame>
  ![Disscussion](/images/0714-disscusion.png)
</Frame>